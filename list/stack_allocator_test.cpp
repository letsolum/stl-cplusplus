...
constexpr size_t STORAGE_SIZE = 100'000'000;
...
int main() {
    ...
    */

    {
        ...
        BasicListTest<StackAllocator<int, 100'000>>(alloc);
    }
    ...
    */
    ...
    {
        StackStorage<10'000> storage;
        StackAllocator<int, 10'000> alloc(storage);

        TestAccountant<StackAllocator<Accountant, 10'000>>(alloc);
    }
    ...
    */

    {
        ...
        TestNotDefaultConstructible<
            StackAllocator<NotDefaultConstructible, 100'000>>(alloc);
    }
